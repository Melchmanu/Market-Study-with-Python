...
## Notebooks 📓
- [Data Preparation and Exploratory Analysis](https://github.com/Melchmanu/Market-Study-with-Python/blob/main/Melchior_Manuel_1_preparation_nettoyage_analyse_exploratoire_122024.ipynb)
- [Clustering and Visualizations](https://github.com/Melchmanu/Market-Study-with-Python/blob/main/Melchiori_Manuel_2_clustering_visualisations_122024.ipynb)
...
- `notebooks/` : Includes separate notebooks for EDA, PCA, and clustering analysis.
  - [Data Preparation and Exploratory Analysis](https://github.com/Melchmanu/Market-Study-with-Python/blob/main/Melchior_Manuel_1_preparation_nettoyage_analyse_exploratoire_122024.ipynb)
  - [Clustering and Visualizations](https://github.com/Melchmanu/Market-Study-with-Python/blob/main/Melchiori_Manuel_2_clustering_visualisations_122024.ipynb)
- [`choix_indicateurs.txt`](https://github.com/Melchmanu/Market-Study-with-Python/blob/main/Choix%20indicateurs.txt) : Documentation justifying the chosen indicators based on the PESTEL method.
